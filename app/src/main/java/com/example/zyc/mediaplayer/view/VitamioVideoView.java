...
public class VitamioVideoView extends VideoView {
     ...
     * @param attrs
     */
    public VitamioVideoView(Context context, @Nullable AttributeSet attrs) {
     ...
     * @param defStyleAttr
     */
    public VitamioVideoView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
